...
- L'application active conserve les PNG comme sources de référence. L'en-tête
  ...
  `florian-*-web.webp`. Le grand lockup d'introduction charge les dérivés
  `monflorian-wordmark-intro.webp` et `florian-*-intro.webp`, issus des mêmes
  masters à une définition adaptée à sa largeur complète.
