/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5aba8de7c39371b6ed7011fbb16d9040)
...
interface __BaseEnv_Env {
	...
	MONFLORIAN_EMAIL_ENABLED: "false";
	MONFLORIAN_EMAIL_FROM: "voyage@monflorian.com";
	MONFLORIAN_PUBLIC_ORIGIN: "https://monflorian.com";
	MONFLORIAN_TRIP_CREATION_ENABLED: "false";
	MONFLORIAN_DAILY_GLOBAL_LIMIT: "10";
	MONFLORIAN_DAILY_CLIENT_LIMIT: "2";
	MONFLORIAN_ALLOWED_ORIGINS: "https://monflorian.com,https://www.monflorian.com,http://127.0.0.1:8080";
	MONFLORIAN_RELEASE: "cloudflare";
	OPENAI_TEXT_MODEL: "gpt-5.4-mini-2026-03-17";
	OPENAI_IMAGE_MODEL: "gpt-image-2";
	TURNSTILE_SITE_KEY: "0x4AAAAAAEaeGxBrM4uuFfHx";
	TRIP_DATA_KEY: string;
	TRIP_QUOTA_HASH_KEY: string;
	TURNSTILE_SECRET_KEY: string;
	TRIP_WORKFLOW: Workflow<Parameters<import("./src/worker").TripWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOOKING_MODE" | "MONFLORIAN_ACCESS_MODE" | "MONFLORIAN_GENERATION_ENABLED" | "MONFLORIAN_ILLUSTRATION_ENABLED" | "MONFLORIAN_EMAIL_ENABLED" | "MONFLORIAN_EMAIL_FROM" | "MONFLORIAN_PUBLIC_ORIGIN" | "MONFLORIAN_TRIP_CREATION_ENABLED" | "MONFLORIAN_DAILY_GLOBAL_LIMIT" | "MONFLORIAN_DAILY_CLIENT_LIMIT" | "MONFLORIAN_ALLOWED_ORIGINS" | "MONFLORIAN_RELEASE" | "OPENAI_TEXT_MODEL" | "OPENAI_IMAGE_MODEL" | "TURNSTILE_SITE_KEY" | "TRIP_DATA_KEY" | "TRIP_QUOTA_HASH_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
